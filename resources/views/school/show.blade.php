            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <section>
                        ...
                        <p>
                            <a href="{{ url('/school', [$school->id]) }}">{{ $school->name }}</a>位于 <a href="{{ url('/province', [$school->province->id]) }}">{{ objProp($school->province, 'name')}}</a><a href="{{ url('/city', [$school->city->id]) }}">{{ objProp($school->city,'name') }}</a>{{ objProp($school->district, 'name') }}
                            ...
                            学校网站{{ empty($school->website) ? '暂无' : $school->website }}。{{ $school->name . config('school.random')[array_rand(config('school.random'))] }}
                        </p>
                    </section>
                    <section>
