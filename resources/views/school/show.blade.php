@extends('layouts.app')
@section('title'){{ transName($school->name) }}网站_{{ $school->name }}查分网站@stop
@section('content')
<div class="container">
    <div class="row">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <section>
                        ...
                        <p>
                            <a href="{{ url('/school', [$school->id]) }}">{{ transName($school->name) }}</a>位于 <a href="{{ url('/province', [$school->province->id]) }}">{{ objProp($school->province, 'name')}}</a><a href="{{ url('/city', [$school->city->id]) }}">{{ objProp($school->city,'name') }}</a>{{ objProp($school->district, 'name') }}
